      ...
      <div className="m-auto">
        <div className="flex items-center justify-end relative w-[325px] h-[53px] md:w-[704px] md:h-[69px] lg:w-[800px]">
          <input
            ...
            className="w-full h-full ring-1 ring-inset pl-14 ring-purple01 rounded-xl placeholder-gray04 text-gray06 text-sm md:text-base transition duration-500 ease-in-out focus-within:ring-2 bg-[url('/icons/link.svg')] bg-no-repeat bg-[20px]"
          />
          <button
            type="button"
