...
const SubSectionContainer = ({ children, image, lottie }: { children: ReactNode; image: string; lottie: object }) => {
  ...
  return (
    <Container className="flex flex-col lg:flex-row lg:items-center justify-center lg:justify-between gap-y-4 md:gap-y-0 screen-height">
      <div
        ref={ref}
        className="flex flex-col-reverse lg:flex-row items-center gap-8 md:gap-12 border-2 rounded-3xl border-purple01/60 shadow-[0_0_10px_rgba(212,188,255,0.6)] w-fit mx-auto lg:mx-0 px-6 md:px-12 lg:pl-8 pt-8 md:pt-12 lg:pt-0"
      >
