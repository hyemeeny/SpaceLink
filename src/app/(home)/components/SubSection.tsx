    ...
    <ul className="flex flex-col items-center gap-y-10 bg-white py-12">
      <li className="flex flex-col md:flex-row md:items-center md:gap-[51px] lg:gap-[157px]">
        <div>
          ...
          <p className="text-gray07 text-sm">나중에 읽고 싶은 글, 다시 보고 싶은 영상, 사고 싶은 옷, 기억하고 싶은 모든 것을 한 공간에 저장하세요.</p>
        </div>
        <Image className="h-auto w-full md:w-[385px] lg:w-[550px]" src="/images/sub_img1.svg" width={550} height={0} alt="sub image1" />
      </li>
      <li className="flex flex-col md:flex-row-reverse md:items-center md:gap-[51px] lg:gap-[157px]">
        ...
        <Image className="h-auto w-full md:w-[385px] lg:w-[550px]" src="/images/sub_img2.svg" width={550} height={0} alt="sub image1" />
      </li>
      <li className="flex flex-col md:flex-row md:items-center md:gap-[51px] lg:gap-[157px]">
        <div>
          <h3 className="text-2xl md:text-5xl font-bold leading-10">
          ...
          <p className="text-gray07 text-sm">여러 링크를 폴더에 담고 공유할 수 있습니다. 가족, 친구, 동료들에게 쉽고 빠르게 링크를 공유해 보세요.</p>
        </div>
        <Image className="h-auto w-full md:w-[385px] lg:w-[550px]" src="/images/sub_img3.svg" width={550} height={0} alt="sub image1" />
      </li>
      <li className="flex flex-col md:flex-row-reverse md:items-center md:gap-[51px] lg:gap-[157px]">
        <div>
          <h3 className="text-2xl md:text-5xl font-bold leading-10">
        ...
        <Image className="h-auto w-full md:w-[385px] lg:w-[550px]" src="/images/sub_img4.svg" width={550} height={0} alt="sub image1" />
      </li>
    </ul>
  );
};
